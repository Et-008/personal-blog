...
> Why did we choose gatsby, when going with Wordpress is so simple?
```markdown
1. Needed a website and needed it real quick.
2. It should be unique and theme matching to our company's brand.
3. Developer friendly with performance and functionality tools out of the box.
```
...
Normally server-side-rendered sites are a little bit faster than conventional sites, but __statically generated sites__ are even faster.
...
But still what all can we do with this library? 
